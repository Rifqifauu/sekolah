        ...
        <div class="w-full md:w-2/3">
          ...
          <div v-else class="space-y-5">
            <div
              ...
              :key="pengumuman.id"
              class="bg-white rounded-xl shadow-sm hover:shadow-md transition overflow-hidden border-l-4 border-green-500"
              data-aos="fade-up"
            >
              <div class="p-6">
                <h2 class="text-xl font-bold text-gray-800 mb-2 hover:text-green-600 transition">{{ pengumuman.judul }}</h2>
                ...
                <Link :href="`/pengumuman/${pengumuman.id}`" class="inline-flex items-center text-green-600 font-medium hover:text-green-800 transition">
