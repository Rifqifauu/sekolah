<template>
   <div class="bg-gray-50 min-h-screen">
    <div class="container mx-auto px-4 py-8">
      <div class="flex flex-col lg:flex-row gap-8">
         <main class="w-full lg:w-2/3 bg-white p-6 rounded-xl shadow-sm" data-aos="fade-up">
          ...
          <div class="flex items-center gap-2 mb-4 text-sm text-gray-600">
            <a href="/" class="flex items-center hover:text-green-950 transition-colors">
      ...
      <div class="mb-4">
        <span class="bg-green-100 text-green-950 text-xs font-medium px-3 py-1 rounded-full">
          {{ artikel.kategori || 'Uncategorized' }}
        </span>
      </div>

      <h1 class="text-2xl md:text-4xl font-extrabold mb-6 text-green-950">{{ artikel.judul }}</h1>
